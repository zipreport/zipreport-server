...
require (
	...
	github.com/oddbit-project/blueprint v0.8.1
	github.com/oddbit-project/blueprint/provider/httpserver v0.8.3
...
require (
	...
	github.com/oddbit-project/blueprint/provider/hmacprovider v0.8.1 // indirect
